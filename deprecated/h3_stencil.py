...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Creates a binary raster mask of the world.")
    parser.add_argument('--n_cells', type=int, default=1000, help="Number of cells in both x and y direction for binary mask")
    parser.add_argument('--h3_resolution', type=int, default=7, help="H3 resolution level")
    parser.add_argument('--n_batches', type=int, default=8, help="Number of batches to split the H3 cells into")
